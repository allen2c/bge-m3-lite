...
| int8 v0.6.1 (layer tail over rows, `memory.md`; M4 with one core busy, the v0.5.2 graph measured 1325 tok/s the same way) | **0.31 s** | 731 MiB | 875 MiB | 1314 MiB | 1366 | 2.52 | 13 / 32 ms | 0 |
